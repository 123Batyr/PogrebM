...
import ru.Meredov.PogrebM.model.User;
import ru.Meredov.PogrebM.model.UserRepository;
...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    static final String HELP_TEXT = "This bot is created to demonstrate Spring capabilities.\n\n" +
            "You can execute commands from the main menu on the left o by typing a command:\n\n" +
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (update.hasMessage() && update.getMessage().hasText()) {
           ...
           if (callbackData.equals(YES_BUTTON)){
               String text = "Вы нажал на нопку ДА";
               executeEditMessageText(text, chatId, messageId);

               } else if (callbackData.equals(NO_BUTTON)){
               String text = "Вы нажал на нопку НЕТ";
               executeEditMessageText(text, chatId, messageId);
...
message.setText("Do you really want to register?");
    ...
    private void startCommandReceived ( long chatId, String name){
        ...
        String answer = EmojiParser.parseToUnicode("Привет,  " + name + ", приятно познакомиться!" + " :blush:");
